...
local mappings = {
	...
	{ "<leader>gD", "<cmd>DiffviewOpen<cr>", desc = "Diffview (Project)", nowait = true, remap = false },
	{ "<leader>go", "<cmd>Telescope git_status<cr>", desc = "Git Status", nowait = true, remap = false },
	...
	{ "<leader>gd", "<cmd>Gitsigns diffthis HEAD<cr>", desc = "Diff (Gitsigns)", nowait = true, remap = false },
